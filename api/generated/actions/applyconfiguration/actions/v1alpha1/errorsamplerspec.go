...
type ErrorSamplerSpecApplyConfiguration struct {
	...
	SampleUnset *bool                        `json:"sample_unset,omitempty"`
}
...
// WithSampleUnset sets the SampleUnset field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the SampleUnset field is set to the value of the last call.
func (b *ErrorSamplerSpecApplyConfiguration) WithSampleUnset(value bool) *ErrorSamplerSpecApplyConfiguration {
	b.SampleUnset = &value
	return b
}
